	...
	public function create() {
		...
		if($lastpage > 1) {
			if($pagenum > 1) {
				...
				$link = "";
				if(!empty($qs)){ $link = "/?" . $qs . "page=" . ($pagenum-1); }
				else{ $link = "/?page=" . ($pagenum-1); }
			...
			if($pagenum < $lastpage) {
				...
				$link = "";
				if(!empty($qs)){ $link = "/?" . $qs . "page=" . $lastpage; }
				else{ $link = "/?page=" . $lastpage; }
