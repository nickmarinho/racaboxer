...
?>
						<tr id='list_<?php echo $c; ?>' class="<?php echo $over; ?>">
                            ...
                            <td style='cursor:pointer;' onclick="javascript:emailpage('<?php echo $_GET['mod']; ?>', '<?php echo $data['id']; ?>');" title="Clique para responder via email"><span class="linktxt"><?php echo $data['email']; ?></span></td>
							<td>
<?php
...
?>
							...
							<td class='tdpag-icons' onclick="javascript:sendconfirmationemail('<?php echo $_GET['mod']; ?>', '<?php echo $data['id']; ?>');" title="Clique para enviar email de aprovação" id="confirmationmail_<?php echo $data['id']; ?>">
								<div class="ui-state-default ui-corner-all img-icons"><span class="ui-icon ui-icon-mail-closed"></span></div>
							</td>
							<td class='tdpag-icons' onclick="javascript:window.open('http://<?php echo $_SERVER['SERVER_NAME'] . '/fotos.php?id=' . $data['id']; ?>');" title="Clique para ver no site">
