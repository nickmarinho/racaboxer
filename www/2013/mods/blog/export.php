		...
		switch($_GET['filetype']) {
			case 'csv':
				...
				while($data = $q->fetch(PDO::FETCH_ASSOC)) {
					...
					$return .= $data['id'] . ";" . $active . ";" . $data['author'] . ";" . $data['title'] . ";" . $data['meta_keywords'] . ";" . $data['meta_description'] . ";" . $data['url'] . ";" . $data['cdate'] . ";" . $modificado . "\r\n";
				}
			...
			case 'sql':
                ...
                while($data = $q->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $return .= "INSERT INTO " . $table . " SET id='" . 
                            $data['id'] . "', author='" . 
                            addslashes(utf8_decode($data['author'])) . "', title='" . 
                            ...
                            addslashes($data['url']) . "', rss='" . 
                            addslashes(utf8_decode($data['rss'])) . "', post='" . 
