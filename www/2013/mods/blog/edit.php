...
<?php
echo insertField("text", "author", "Autor", "75", $data['author'], "");
...
echo insertField("textarea", "rss", "RSS", "cols='85' rows='24' ", stripslashes($data['rss']), "");
