...
?>
						<tr id='list_<?php echo $c; ?>' class="<?php echo $over; ?>">
							...
							<td style='cursor:pointer;' onclick="javascript:editpage('<?php echo $_GET['mod']; ?>', '<?php echo $data['id']; ?>');" title="Clique para editar"><?php echo $data['author']; ?></td>
...
?>
							...
							<td class='tdpag-icons'>
								<a href="http://<?php echo $_SERVER['SERVER_NAME'] . '/blog.php?id=' . $data['id']; ?>" target="_blank" title="Clique para ver no site">
