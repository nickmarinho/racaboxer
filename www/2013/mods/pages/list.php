...
?>
						<tr id='list_<?php echo $c; ?>' class="<?php echo $over; ?>">
							...
							<td style='cursor:pointer;' onclick="javascript:editpage('<?php echo $_GET['mod']; ?>', '<?php echo $data['id']; ?>');" title="Clique para editar"><?php echo $data['url']; ?></td>
...
?>
							...
							<td class='tdpag-icons'>
								<a href="http://<?php echo $_SERVER['SERVER_NAME'] . '/index.php?page=' . $data['id']; ?>" target="_blank" title="Clique para ver no site">
