...
(function($) {
	$.fn.jqGalScroll = function(options){
		return this.each(function(i){
			...
			el.container = $('<div id="jqGS'+i+'" class="jqGSContainer" style="width:745px !important;">').css({position:'relative'});
			...
			el.pagination = $('<div class="jqGSPagination" style="width:745px !important;">');
			...
			.each(function(j){
				...
				image.onload = function(){
					image.onload = null;
					$loader.fadeOut();
					jqimg.css({marginLeft:-image.width*.5,marginTop:-image.height*.5,margin:'0 auto',position:'relative',top:'10px'}).fadeIn();
