...
(function($){
	...
	var defaults = {
		...
		minimalTopSpacingOfModalbox 		: 0, // sets the minimum space between modalbox and visible area in the browser window
		usejqueryuidragable					: true, //options: true, false (the modalbox is draggable, Requires jQuery v1.2.6 or later, jQuery UI  and components: jQuery UI Widget, jQuery UI Mouse, jQuery UI Draggable)
		killModalboxWithCloseButtonOnly		: false, // options: true, false (close the modal box with close button only)
		setWidthOfModalLayer				: 1002,
