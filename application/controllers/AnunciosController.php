...
class AnunciosController extends Zend_Controller_Action
{
	...
	/* LIST ACTIONS */
	public function listanunciosAction()
	{
	...
	/* SAVE ACTIONS */
	public function saveanunciosAction()
	{
		$this->view->layout()->disableLayout();
	...
	/* ADD ACTIONS */
	public function addanunciosAction()
	{
		$this->view->layout()->disableLayout();
		$this->_helper->viewRenderer->setNoRender(true);
		$request = $this->getRequest();
	...
	/* EDIT ACTIONS */
	public function editanunciosAction()
	{
		$this->view->layout()->disableLayout();
		$this->_helper->viewRenderer->setNoRender(true);
		$request = $this->getRequest();
	...
	/* REMOVE ACTIONS */
	public function removeanunciosAction()
	{
		$this->view->layout()->disableLayout();
		$this->_helper->viewRenderer->setNoRender(true);
		$request = $this->getRequest();
	...
	/* VIEW ACTIONS */
	public function viewanunciosAction()
	{
		$this->view->layout()->disableLayout();
		$this->_helper->viewRenderer->setNoRender(true);
		$request = $this->getRequest();
	...
	/* ACTIVE */
	public function activeonoffanunciosAction()
	{
		$this->view->layout()->disableLayout();
		$this->_helper->viewRenderer->setNoRender(true);
		$request = $this->getRequest();
	...
	{
		$this->settitle("Home of Anuncios");
		$this->setheaders();
		$auth = Zend_Auth::getInstance();
	...
	/* GET FORMS */
	protected function _getAnunciosLoginForm()
	{
	...
	protected function _getFormAnuncios($options = null)
	{
		if(null === $this->_formanuncios)
		{
			require_once APP_PATH . '/forms/FormBlog.php';
			$this->_formanuncios = new Form_Blog($options);
		}
		
		return $this->_formanuncios;
	}
	
	/* GET MODELS */
	protected function _getModelAnuncios()
	{
		if(null === $this->_modelanuncios)
		{
			require_once APP_PATH . '/models/Blog.php';
			$this->_modelanuncios = new Model_Blog();
		}
		
		return $this->_modelanuncios;
	}
